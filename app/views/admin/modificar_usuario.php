...
<form method="POST" action="/Desafío2/app/controllers/UsuariosController.php?action=actualizar" enctype="multipart/form-data">
<input type="hidden" name="action" value="actualizar">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" name="tipo" required>
            ...
            <option value="cliente" <?= (isset($usuario['tipo']) && $usuario['tipo'] === 'cliente') ? 'selected' : ''; ?>>Cliente</option>
        </select>
    </div>
